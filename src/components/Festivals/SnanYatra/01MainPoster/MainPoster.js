...
const MainPoster = () => {
  ...
  return (
    <>
      {/* poster section  */}
      <div className="relative h-[90vh] w-full overflow-hidden mt-2"> 
      ...
      <div className="relative bg-[url('/Festivels/snanyatra/curve.svg')] h-[150px] bg-cover bg-center w-full z-10 mt-[-149px]"></div>
    </>
  );
};
