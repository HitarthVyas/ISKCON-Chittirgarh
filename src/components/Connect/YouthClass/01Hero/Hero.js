          ...
          <div className="lg:w-full sm:w-10/12 w-full">
            ...
            <div className="text-white text-base sm:text-lg text-justify">
              <motion.p
                ...
                className="mb-4"
              >
                ISKCON Chittorgarh&apos;s seminars and workshops promote the
                study of Srila Prabhupada&apos;s books and a lifestyle based on
                Vedic scriptures. They encourage the application and teaching of
              ...
              >
                These programs educate youth on Srila Prabhupada&apos;s
                teachings through interactive classes. Weekend sessions focus on
                applying Vedic wisdom to modern challenges and offer courses
                like &apos;Art of Mind Control&apos; and &apos;Secrets of
