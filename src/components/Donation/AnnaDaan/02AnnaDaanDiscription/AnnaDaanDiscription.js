...
const AnnaDaanDiscription = () => {
  return (
    <>
      <div className="w-full  bg-cover bg-center py-10"
      style={{
       background: 'linear-gradient(to bottom, #ca0b18 10%, #e75e16 90%, #ffaf2f )',
      }}
      >
...
export default AnnaDaanDiscription;
