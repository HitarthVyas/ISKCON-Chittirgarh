...
import VaishanvSevaDiscription from "../02VaishanvSevaDiscription/VaishanvSevaDiscription";
  ...
  return (
    <div className="">
      <div className="relative h-[80vh] max-[1043px]:h-[100vh]  w-full">
        <div className="absolute inset-0 bg-[url('/Donation/VaishnavSeva/maxresdefault.jpg')] bg-cover bg-top"></div>
